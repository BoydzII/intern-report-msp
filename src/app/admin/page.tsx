    ...
    <div className="max-w-5xl mx-auto mt-4 print:mt-0 print:p-0">
      ...
      <div className="hidden print:block text-center mb-2">
        <div className="flex justify-center items-center gap-6 mb-1">
          ...
          <img src="/school-logo.jpg" alt="เนเธฃเธเน€เธฃเธตเธขเธเธเธฒเธเธเนเธญเธ" className="h-14 object-contain mix-blend-multiply" />
          
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="/msp-logo.jpg" alt="เนเธเธฃเธเธเธฒเธฃเธซเนเธญเธเน€เธฃเธตเธขเธเธเธดเน€เธจเธฉเธงเธดเธ—เธขเธฒเธจเธฒเธชเธ•เธฃเนเธชเธธเธเธ เธฒเธเนเธฅเธฐเธเธฒเธฃเนเธเธ—เธขเน (MSP)" className="h-12 object-contain mix-blend-multiply" />
        </div>
        <div className="text-center mb-1 px-4">
          <p className="text-base font-extrabold text-gray-900 tracking-wide">
            เนเธเธฃเธเธเธฒเธฃเธซเนเธญเธเน€เธฃเธตเธขเธเธเธดเน€เธจเธฉเธงเธดเธ—เธขเธฒเธจเธฒเธชเธ•เธฃเนเธชเธธเธเธ เธฒเธเนเธฅเธฐเธเธฒเธฃเนเธเธ—เธขเน
          </p>
          <p className="text-sm font-bold text-gray-900">เธฃเธฐเธ”เธฑเธเธกเธฑเธเธขเธกเธจเธถเธเธฉเธฒเธ•เธญเธเธเธฅเธฒเธข</p>
        </div>
        ...
        <p className="text-xs mt-1 font-medium">เธ เธฒเธเน€เธฃเธตเธขเธเธ—เธตเน {term} เธเธตเธเธฒเธฃเธจเธถเธเธฉเธฒ {academicYear}</p>
      </div>
